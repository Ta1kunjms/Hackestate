      ...
      <svg width="64" height="64" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.10)', borderRadius: '50%', background: 'white', border: '4px solid #fff' }}>
        <defs>
          <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="100%" style={{ stopColor: '#3A8DFF', stopOpacity: 1 }} />
          </linearGradient>
        </defs>
        {/* Background circle */}
        <circle cx="100" cy="100" r="95" fill="url(#grad1)" stroke="#ffffff" strokeWidth={5} />

        {/* Robot face */}
        <rect x="50" y="60" rx={15} ry={15} width="100" height="80" fill="#ffffff" />
        ...
        {/* Mouth */}
        <path d="M 75 120 Q 100 135, 125 120" stroke="#3A8DFF" strokeWidth={4} fill="none" strokeLinecap="round" />

        {/* Antenna */}
        <line x1="100" y1="30" x2="100" y2="60" stroke="#ffffff" strokeWidth={5} />
